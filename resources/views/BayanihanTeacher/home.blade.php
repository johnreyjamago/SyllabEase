...
<body>
    <div class="p-4 pb-4 mt-14">
        <div class="flex" id="whole">
            ...
            <div class="flex z-10">
                <div id="icon" class="mr-5 flex items-center bg-white h-fit rounded-lg justify-center p-1 shadow-2xl hover:scale-110 transition ease-in-out">
                ...
                <!-- <div id="icon" class="m-5 flex items-center bg-white h-fit rounded-lg justify-center p-1 shadow-2xl hover:scale-110 transition ease-in-out">
        ...
        <!-- Syllabus here -->
        <div class="">
        <h1 class="mb-4 mt-2 text-blue text-2xl font-semibold">Syllabi</h1>
        <div class="">
            ...
            {{-- <div class="justify-end flex">
                <form action="{{ route('admin.home') }}" method="get">
                    <select class="form-control bg-gray-200 px-2 border-2 border-blue2 rounded-lg" name="roleFilter" id="roleFilter">
                        <option value="2" {{ $roleFilter = '2' ? 'selected' : '' }}>Pending</option>
                        <option value="3" {{ $roleFilter = '3' ? 'selected' : '' }}>Completed</option>
                        <option value="all" {{ $roleFilter = 'all' ? 'selected' : '' }}>All</option>
                    </select>
                    <button type="submit" class="mr-20 text-blue">Apply Filter</button>
                </form>
            </div> --}}
