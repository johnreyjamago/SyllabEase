...
<div class="m-auto bg-slate-100 mt-[120px] p-2 shadow-lg bg-gradient-to-r from-[#FFF] to-[#dbeafe] rounded-lg w-11/12">
       <div> 
            <img class="edit_user_img text-center p-6 mt-4 w-[550px] m-auto mb-6" src="/assets/Create Program Educational Objectives.png" alt="SyllabEase Logo">
                <div class="mb-10 pb-10">
                    <div class="ml-20 items-center">
                        <form action="{{ route('chairperson.storePoe') }}" method="POST">
                            @csrf
                            <div class="">
                                <div id="input-container" class="ml-2">
                                    <input placeholder="PEO1" type="text" name="poe_code[]" id="po_letter" class="text-center w-16 border-2 border-solid border-sePrimary" required> : </input>
                                    <input placeholder="e.g Graduates are proficient in the IT field and able to engage constantly in technological and professional advancement by pursuing a higher...." type="text" name="poe_description[]" id="po_description" class="w-5/6 border-2 border-solid border-seSecondary" required></input>
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary text-white font-semibold px-6 py-2 rounded-lg m-2 mt-30 mb-4 bg-blue">Create Program Educational Objectives</button>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addButton.addEventListener('click', function () {
            ...
            newInput1.type = 'text';
            newInput1.name = 'poe_code[]';
            newInput1.classList.add('w-16', 'border-2', 'border-solid', 'border-sePrimary', 'text-center');
            ...
            newInput2.type = 'text';
            newInput2.name = 'poe_description[]';
