            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            <a href="{{ route('generateSyllabusPDF', $syll_id) }} type=" button" class="mr-2 flex text-sm bg-white justify-center items-center rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                                <div class="w-8 h-8 rounded-full text-white text-sm flex justify-center items-center">
                                    <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Interface / Download">
                                            <path id="Vector" d="M6 21H18M12 3V17M12 17L17 12M12 17L7 12" stroke="#2468d2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                    </svg>
                                </div>
                            </a>
                        ...
                        <div>
                            <button type="button" class="flex text-sm bg-white justify-center items-center rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-versions">
                        ...
                        <div class="flex">
                            <div class="hidden max-h-[500px] overflow-y-auto px-3 pb-2  w-[400px] z-50 hidden my-4 text-base list-none bg-[#f3f4f6] rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-versions">
                                ...
                                <div>
                                    ...
                                    @php
                                    $currentRouteMatches = request()->route()->getName() === 'chairperson.viewSyllabus' &&
                                    request()->route('syll_id') == $syllabusVersion->syll_id;
                                    $bgColorClass = $currentRouteMatches ? 'bg-blue2' : 'bg-white';
                                    @endphp

                                    <a href="{{ route('chairperson.viewSyllabus', $syllabusVersion->syll_id) }}" class="">
