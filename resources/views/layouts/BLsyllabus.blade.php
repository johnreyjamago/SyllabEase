            ...
            <div class="fixed top-0 z-50" id="nav">
                <nav class="w-screen flex px-6 md:shadow-lg items-center relative bg-blue py-1">
                    ...
                    <div id="cm" class="md:px-2 ml-auto md:flex md:space-x-3 absolute md:relative top-full left-0 right-0">
                        <!-- history button -->
                        <a href="{{ route('bayanihanleader.viewAudit', $syll_id) }}" method="post" class="hover:bg-blue3 rounded-full cursor-pointer w-8 h-8 mx-1 flex justify-center md:inline-flex items-center justify-center">
                        ...
                        <div id="dropdownVersion" class="hidden pt-2 px-3 pb-7 transition duration-300 md:absolute top-full right-0 md:w-[350px] bg-white bg-opacity-90 md:shadow-lg md:rounded">
                            ...
                            <a href="{{ route('bayanihanleader.viewSyllabus', $syllabusVersion->syll_id) }}" class="">
                                <div class="p-2 flex justify-between hover:bg-blue2 rounded {{ $bgColorClass }}">
                                    ...
                                    <div>
                                        <form action="{{ route('bayanihanleader.destroySyllabus', $syll->syll_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this syllabus version?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <a onclick="dropDownComment()" id="modeButton" class="hover:bg-blue2 bg-blue3 rounded-full cursor-pointer w-[180px] px-2 h- flex justify-center md:inline-flex items-center justify-center">
                            @if(request()->route()->getName() == 'bayanihanleader.commentSyllabus')
                        ...
                        <div id="dropDownComment" class="hidden mt-1 transition duration-300 md:absolute top-full right-[90px] md:w-[200px] bg-white bg-opacity-90 md:shadow-lg md:rounded">
                            ...
                            <a href="{{ route('bayanihanleader.commentSyllabus', $syll_id) }}" method="post" class="flex flex-row items-center my-2 mx-1 rounded shadow  hover:border hover:border-gray3">
                                <div class="mx-2 my-2">
                                    <svg width="15px" height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
